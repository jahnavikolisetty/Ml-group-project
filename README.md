# Ml-group-project
This repository contains the project named Predictive Modeling for Movie Preferences Using Machine Learning Models
...
project structure :
 ...
 dataset folder have ratings and movies.csv ( its too big to upload so we can download the dataset 
from this link https://grouplens.org/datasets/movielens/20m/ and use these rating and movies.csv)
